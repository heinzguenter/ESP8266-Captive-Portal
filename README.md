...
Credits: [Spacehuhn](https://github.com/SpacehuhnTech) for inspiration of the dashboard, [adamff-dev](https://github.com/adamff-dev) for the idea and inspiration for parts of the code, and [sankethj](https://github.com/sankethj) also for inspiration for parts of the code.
